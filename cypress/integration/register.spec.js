...
describe ("Registration", ()=>{
    ...
    it.only("Register with valid data", ()=>{
        ...
        cy.get(Locators.Register.Register).eq(1).click()
        cy.get(Locators.Register.SignUp).should("be.visible").and("have.value", "Sign up")
        cy.get(Locators.Register.Email).eq(0).type("mail11mail@mail.com")
        ...
        cy.get(Locators.Register.SignUp).click({ force: true })
        cy.url().should("have.text", "https://notify.kolosek.com/tasks")
    })
